      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 rounded-md bg-surface-input text-white border ${
              isEditing ? "border-brand focus:ring-2 focus:ring-brand/20" : "border-transparent"
        ...
        {isEditing && (
          <button
            onClick={handleSave}
            disabled={loading}
            className="mt-2 w-full sm:w-auto btn-primary px-4 py-2 rounded-lg font-medium shadow-lg transition disabled:opacity-50"
          >
            {loading ? "Saving..." : "Save"}
          </button>
        )}
